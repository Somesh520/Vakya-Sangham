...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    padding: 20,
    backgroundColor: '#F5E8C7', // Already matches DateOfBirthScreen, AboutYouScreen, and CreateAccountScreen
    paddingTop: 120,
  },
  header: {
    flexDirection: 'row',
  ...
  progressFill: {
    height: '100%',
    width: '60%', // Adjust this value to match the progress (e.g., 60% for 3/5)
    backgroundColor: '#000',
    borderRadius: 5,
  },
  title: {
  ...
  option: {
    ...
    marginVertical: 5,
    backgroundColor: '#F5E8C7', // Updated to match container background
  },
  optionSelected: {
    borderColor: '#000',
